...
/*
reset			RESET	  U		pc5	adc - czujnik ciśnienia
LED0			pd0				pc4		
LED1			pd1				pc3		
LED2			pd2				pc2
LED3			pd3				pc1	
...
void tim1_set(int t){
	...
	TCCR1B |= (1<<CS12); //przy 1mhz daje to 3906.25 cykli na sekundę, czyli 3.90625 cykla na milisekundę
...
void tim0_set(int t){
	...
	TCCR0 |= (1<<CS02) | (1<<CS00); //przy 1mhz daje to 976.5625 cykli na sekundę, czyli 1ms = 0.9765625 cykla
}
